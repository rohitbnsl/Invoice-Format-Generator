...
class InvoiceGenerator:
    def __init__(self,root):
        ...
        Label(self.frame,text="Enter your company details ",font=("times new roman",30,"bold"),bg="white",fg="black",bd=0).place(x=50,y=10)
        ...
        # ====submit details
        Button(self.frame, text = "Submit Details",command = self.generate_invoie, font = ("times new roman", 14),fg = "white",cursor = "hand2", bg = "#B00857").place(x = 50, y = 640, width = 180, height = 40)
